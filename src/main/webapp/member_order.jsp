...
<script type="text/javascript">
   ...
   <div class="cmain mb_back">
        ...
        <div class="zbk_top spalid">
        	<span>您当前的位置：</span>
        	<span id="ctl00_content_website_SiteMapPath1"><span> <a href="javascript:void(0)">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <a href="javascript:void(0)">我的DR</a> </span><span> <em>&gt;</em> </span><span> <span>我的订单</span>								</span>
						</span>
        </div>
                    ...
                    <div class="member_all-nav">
                    	<div class="member_all-nav-top">
                            ...
                            <div class="member_all-nav-right fr">
                               ...
                               <a target="_blank" style="cursor: pointer" onClick="javascript:void(0)">在线客服>></a>
                            </div>
                            <!--右边end-->
                        </div>
                        <!--黄色线-->
	                    ...
	                    <table cellspacing="0" cellpadding="0" border="0" class="member_title-table">
	                    	<tbody>
		                    	<tr class="member_myorder-table-first">
		                        	<td class="myorder-table_td1" style="width: 155px;">订单状态</td>
		                            <td class="myorder-table_td2">商品数量</td>
		                            <td class="myorder-table_td2">付款金额</td>
		                            <td class="myorder-table_td4">物流信息</td>
		                            <td class="myorder-table_td5">订单备注</td>
		                            <td class="myorder-table_td6">操作</td>
		                        </tr>
	                    	</tbody>
	                     </table>
	                     <c:forEach items="${orderList }" var="list">  
		                     <table cellspacing="0" cellpadding="0" border="0" class="member_myorder-table" style="margin-left: 50px;">
	                            <tbody>
	                                  <tr class="member_myorder-table-sec">
	                                      <td class="myorder-table-sec_td1" colspan="4">订单号：${list.order.oid }</td>
	                                      <td class="myorder-table-sec_td2" colspan="2">下单时间：${list.order.odate }</td>
	                                  </tr>
	                                      <tr class="member_myorder-table-third">
	                                          <td class="myorder-table_td1" style="width: 100px;">
	                                                ${list.order.ostatus }
	                                          </td>
	                                          ...
	                                          <td class="myorder-table_td6">
	                                               <p>
	                                                  <a href="<%=path %>/order/findByOid.do?oid=${list.order.oid }">查看</a>
	                                              </p>
	                                          </td>
	                                      </tr>
	                     			</tbody>
