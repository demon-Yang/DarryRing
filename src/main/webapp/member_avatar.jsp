...
<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<%=path %>/css/uploadify.css" />
		...
		<script type="text/javascript" src="<%=path %>/js/Jcrop_photo.js"></script>
			...
			<div class="tobuy cmain">
				<div class="cmain mb_back">
					<div class="zbk_top spalid">
						<span>您当前的位置：</span>
						<span id="ctl00_content_website_SiteMapPath1"><span> <a href="javascript:void(0)">Darry Ring</a> <em>&gt;</em>  <a  href="javascript:void(0)">我的DR</a> <em>&gt;</em> </span><span> <span>修改头像</span>	</span>
						</span>
					</div>
							...
							<div class="member_person">
								...
								<div class="member_person-upload">
									<div id="uploadimg" class="uploadify" style="height: 30px; width: 120px;">
										<form action="<%=path %>/user/modifyUimg.do" method="post" id="form" enctype="multipart/form-data">
											<input type="file" name="uimg" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg"/>
										</form>
									</div>
								...
								<div class="member_person-upload">
									<div style="width: 300px; height: 300px; position: relative; background-color: rgb(205, 205, 205);" class="jcrop-holder">
										<img style="width: 300px; height: 300px; position: absolute; opacity: 0.5;" src="<%=path %>/${user.uimg }" />
									</div>
