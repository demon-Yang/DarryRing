				...
				<div class="main-content-inner">
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<c:forEach items="${pages.list }" var="list">
												<tr>
													...
													<td class="center ologistics">
														<select style="height: 25px;" name="ologistics">
													...
													<td class="center"><a style="color: red;cursor: pointer;" href="javascript:void(0)" onclick="deal(this,${list.order.oid})">${list.order.ostatus }</a></td>
												</tr>
					...
					<div class="page col-md-12">
						<ul class="pagination pull-right no-margin">
							<li>
								<a href="#" style="color: #eaa255;background-color: #ffffff;border: 0;padding-right: 2px;">共${allUnNum }件&nbsp;商品</a>
							</li>
							<li>
								<a href="#" style="color: #eaa255;background-color: #ffffff;border: 0;">${pages.pageNum}/${pages.pages }</a>
							</li>
							<li class="prev ">
								<a href="<%=path %>/order/findAllUn.do?pageNum=${pages.prePage }">
									<i class="ace-icon fa fa-angle-double-left"></i>
								</a>
							</li>
			
							<li class="next">
								<a href="<%=path %>/order/findAllUn.do?pageNum=${pages.nextPage }">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function deal(deals,oid){
				var ologistics =$(deals).parent().siblings('.ologistics').find('option:selected').val();
				if(confirm("确定受理吗？")){
					$.ajax({
						type:"get",
						url:"<%=path %>/order/modify.do",
						data:{oid:oid,ologistics:ologistics},
						success:function(msg){
							location.reload();
						}
					});
