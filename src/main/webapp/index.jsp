...
<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
	...
	<head>
		...
		<link href="<%=path %>/css/index_A.css?v=1.3.7.1" type="text/css" rel="stylesheet" />
		<link href="<%=path %>/css/same_A.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
		...
		<div class="nav">
			<div class="cmain">
				...
				<ul class="nav-ul fl">
					...
					<li><a style="font-family:arial" href="<%=path%>/lists.jsp">Darry Ring 求婚钻戒</a>
						<div class="nav-div">
					...
					<li class="tb_first" style="display: block; opacity: 0.982279;">
						<div class="cmain cb_main">
							...
							<div class="banner-word sp_width">
								<img src="<%=path %>/images/dr_logo.png" />
								...
								<div class="button sp_button">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/brand.jsp">了解品牌文化</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="all-thing">
				<div class="cmain">
					...
					<ul class="news-ul">
						...
						<li>
							<div>
								<img width="235" height="130" alt="Darry Ring实体店" src="<%=path%>/images/tyzx.jpg" />
							</div>
							<div class="ul-center">
								<a href="javascript:void(0)" class="">Darry Ring实体店</a>
							</div>
							<div class="ul-bottom">
							</div>
						</li>
						...
						<li>
							<div>
								<img width="235" height="130" alt="Darry Ring" src="<%=path%>/images/zajz.jpg" />
								<div class="ul-center">
									<a href="javascript:void(0)" class="">Darry Ring(DR真爱钻戒)</a>
								</div>
						...
						<li>
							<div>
								<img width="235" height="130" alt="社会名人倾情推荐" src="<%=path%>/images/famous.jpg" />
							</div>
							<div class="ul-center">
								<a href="javascript:void(0)">明星 DR 族</a>
							</div>
							<div class="ul-bottom">
							</div>
						</li>
						...
						<li>
							<div>
								<img width="235" height="130" alt="网络热门钻戒品牌" src="<%=path%>/images/wlzj.jpg" />
							</div>
							<div class="ul-center">
								<a href="javascript:void(0)" class="">Darry Ring 定制</a>
							</div>
							<div class="ul-bottom">
							</div>
						</li>
					...
					<ul class="all_tab">
						<li style="display: none;">
							...
							<div class="tab_left fl">
								<img width="504" height="314" alt="Forever经典系列" src="<%=path%>/images/fimg6.jpg" />
							</div>
							<!--tab选项卡下的左边内容 end-->
							<!--tab选项卡下的右边内容-->
							<div class="tab_right fr">
								...
								<div class="to_more">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/goods/findByCondition.do?gseries=Forever系列">了解更多</a>
									</div>
								</div>
							</div>
							<!--tab选项卡下的右边内容  end-->
						...
						<li style="display: none;">
							<!--tab选项卡下的左边内容-->
							<div class="tab_left fl">
								<img width="504" height="314" alt="Marry Me系列" src="<%=path%>/images/fimg1.jpg" />
							</div>
							<!--tab选项卡下的左边内容 end-->
							<!--tab选项卡下的右边内容-->
							<div class="tab_right fr">
								...
								<div class="to_more">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/goods/findByCondition.do?gseries=MarryMe系列">了解更多</a>
									</div>
								</div>
							</div>
							<!--tab选项卡下的右边内容  end-->
						...
						<li style="display: none;">
							<!--tab选项卡下的左边内容-->
							<div class="tab_left fl">
								<img width="504" height="314" alt="My heart系列" src="<%=path%>/images/fimg2.jpg" />
							</div>
							<!--tab选项卡下的左边内容 end-->
							<!--tab选项卡下的右边内容-->
							<div class="tab_right fr">
								...
								<div class="to_more">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/goods/findByCondition.do?gseries=MyHeart系列">了解更多</a>
									</div>
								</div>
							</div>
							<!--tab选项卡下的右边内容  end-->
						...
						<li style="display: list-item; opacity: 0.470565;">
							<!--tab选项卡下的左边内容-->
							<div class="tab_left fl">
								<img width="515" height="314" alt="True Love系列" src="<%=path%>/images/fimg3.jpg" />
							</div>
							<!--tab选项卡下的左边内容 end-->
							<!--tab选项卡下的右边内容-->
							<div class="tab_right fr">
								...
								<div class="to_more">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/goods/findByCondition.do?gseries=TrueLove系列">了解更多</a>
									</div>
								</div>
							</div>
							<!--tab选项卡下的右边内容  end-->
						...
						<li style="opacity: 0.529435; display: list-item;">
							<!--tab选项卡下的左边内容-->
							<div class="tab_left fl">
								<img width="504" height="314" alt="I Swear系列" src="<%=path%>/images/fimg4.jpg" />
							</div>
							<!--tab选项卡下的左边内容 end-->
							<!--tab选项卡下的右边内容-->
							<div class="tab_right fr">
								...
								<div class="to_more">
									<div class="bt2">
										<a target="_blank" href="<%=path %>/goods/findByCondition.do?gseries=ISwear系列">了解更多</a>
									</div>
								</div>
							</div>
							<!--tab选项卡下的右边内容  end-->
					...
					<!--推荐款式-->
					<div class="hot-ks">
						<a class="fr" target="_blank" href="<%=path %>/goods/findByCondition.do">更多</a>
						<span id="rxph" class="other_color"><i>热销商品</i><em></em> </span>
					</div>
					<!--购买的款式-->
					<div class="cmain">
						<ul id="ullist" class="buyit">
							<c:forEach items="${goodsList }" var="list">
								<li>
									<div class="by_top">
										<a target="_blank" href="<%=path %>/goods/findByGid.do?gid=${list.goods.gid}" rel="nofollow"></a>
										<div style="opacity:1" class="bything-one">
											<img width="236px" height="236px" src="<%=path %>/${list.goods.gimg1 }" />
										</div>
									</div>
									<div class="by_center"></div>
									<div class="by_bottom">
										<p><a target="_blank" href="detail.jsp">${list.goods.gseries }&nbsp;&nbsp;${list.goods.gname } </a></p>
